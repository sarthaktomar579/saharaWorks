          ...
          <div className="payment flex gap-3 w-[80%] mt-11">
            ...
            <div className="supporters w-1/2 rounded-lg bg-slate-900 text-white py-5 px-10">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div>
                  <input onCha={handleChange()} value={} type="text" className='w-full rounded-lg p-3 bg-slate-800' placeholder='Enter Name' />
                </div>

                <input onCha={handleChange()} value={} type="text" className='w-full rounded-lg p-3 bg-slate-800' placeholder='Enter Message' />
                <input onCha={handleChange()} value={} type="text" className='w-full rounded-lg p-3 bg-slate-800' placeholder='Enter Amount' />
