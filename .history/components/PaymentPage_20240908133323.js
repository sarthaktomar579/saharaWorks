          ...
          <div className="payment flex gap-3 w-[80%] mt-11">
            ...
            <div className="supporters w-1/2 rounded-lg bg-slate-900 text-white py-5 px-10">
              ...
              <div className="mt-5 flex gap-2">
                <button className='bg-slate-800 p-3 rounded-lg' onc>Pay ₹10</button>
                <button className='bg-slate-800 p-3 rounded-lg' onc>Pay ₹20</button>
                <button className='bg-slate-800 p-3 rounded-lg' onc>Pay ₹50</button>
              </div>
            </div>
