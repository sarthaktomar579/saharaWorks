  ...
  return (
    <>
      ...
      <div className='cover w-full relative'>
        ...
        <div className='absolute -bottom-16 right-[46%] border-white border-2 rounded-full overflow-hidden size-36'>
      ...
      <div className='info flex flex-col justify-center gap-1 items-center my-20'>
        ...
        <div className="payment flex gap-3 w-[80%] mt-11 flex-col md:flex-row">
          <div className="supporters md:w-1/2 w- rounded-lg bg-slate-900 text-white py-5 px-8">
