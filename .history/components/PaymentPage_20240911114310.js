        ...
        <div className="payment flex gap-3 w-[80%] mt-11">
          ...
          <div className="supporters w-1/2 rounded-lg bg-slate-900 text-white py-5 px-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <button onClick={() => pay(Number.parseInt(paymentform.amount)*100)} type="button" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 disabled: bg-slate-600" disabled={pay}>Pay</button>
            </div>
