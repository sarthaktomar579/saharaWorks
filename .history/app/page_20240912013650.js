  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center gap-4 text-white h-[44vh] px-5 md:px-0 text-xs md:text-base">
        <div className="md:text-5xl font-bold flex items-baseline justify-center gap-5 items-center text-xl">Buy Me a Chai <span><img width={58} src="/tea.gif" alt="" /></span></div>
        <p>
          A crowdfunding paltform. Get funded by your fans and followers. Start now!
        </p>
        <p>
          A place where your fans can buy you a chai. Unleash the power of your fans an
        </p>
        <div>
          <Link href={"/login"}>
