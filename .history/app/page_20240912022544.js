  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center gap-4 text-white h-[44vh] px-5 md:px-0 text-xs md:text-base">
        <div className="md:text-5xl font-bold flex items-baseline justify-center md:gap-5 gap-2 text-3xl">Buy Me a Chai <span><img width={58} src="/tea.gif" alt="" /></span></div>
      ...
      <div className="container mx-auto text-white pb-14 pt-16 flex flex-col items-center justify-center">
       ...
       <div className="w-[90%] h-[40vh] md:w-[50%] md:h-[40vh] lg:w-[50%] lg:h-[80vh] xl:w-[50%] xl:h-[80vh]">
       <iframe className="w-full h-full" src="https://www.youtube.com/embed/QtaorVNAwbI" title="Project GetMeAChai - Patreon Clone in Next.js | Sigma Web Development Course - Tutorial #131" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
       </div>
