...
export default function Home() {
  return (
    <>
      ...
      <div className="container mx-auto text-white pb-32 pt-14">

        <h1 className="text-2xl font-bold text-center my-7 ">Your Fans can buy you a Chai</h1>
      ...
      <div className="container mx-auto text-white pb-32 pt-1">
