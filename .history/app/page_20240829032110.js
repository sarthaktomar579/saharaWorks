...
export default function Home() {
  return (
    <>
      ...
      <div className="container mx-auto text-white pb-12 pt-114">

        <h1 className="text-2xl font-bold text-center mb-7">Your Fans can buy you a Chai</h1>
      ...
      <div className="container mx-auto text-white pb-2 pt-1">

        <h1 className="text-2xl font-bold text-center ">Your Fans can buy you a Chai</h1>
