  ...
  return (
    <>
      ...
      <div className="container mx-auto text-white pb-14 pt-16">
        ...
        <h1 className="text-3xl font-bold text-center mb-10">Your Fans can buy you a Chai</h1>
      ...
      <div className="container mx-auto text-white pb-14 pt-16 flex flex items-center justify-center">

        <h1 className="text-3xl font-bold text-center mb-10">Learn more about us</h1>

        <iframe width="91" height="514" src="https://www.youtube.com/embed/QtaorVNAwbI" title="Project GetMeAChai - Patreon Clone in Next.js | Sigma Web Development Course - Tutorial #131" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
